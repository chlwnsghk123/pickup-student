...
function playTone(freq, type='sine', dur=0.3, vol=0.18, delay=0){
...
function stopSteps(){ clearInterval(stepInterval); stepInterval=null; }
...
function startBgMusic(){
  ...
  const key=THEMES[currentTheme].musicKey||'city';
